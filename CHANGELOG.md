...
### Changed
- enabling rx optimization in Coraza 3.6.0 ([#14](https://github.com/aaronspruit/coraza-envoy-go-filter-image/pull/14))
...
- Add CRS plugins capability ([#12](https://github.com/aaronspruit/coraza-envoy-go-filter-image/pull/12))
